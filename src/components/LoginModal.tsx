  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-primary/[0.07] rounded-full blur-[120px] animate-float" />
        <div
          className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-blue-400/[0.05] rounded-full blur-[100px] animate-float"
          ...
          <div className="bg-card rounded-2xl p-8 backdrop-blur-xl shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-foreground mb-2 font-heading">
                Welcome to <span className="gradient-text">WebMaker</span>
              </h1>
